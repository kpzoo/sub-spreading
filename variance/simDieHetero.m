% Simulate M epidemics at various k values (heterogeneity)
clearvars; clc;
close all; tic;
...
for ii = 1:lenk
    ...
    for j = 1:M
        ...
        while Iwarn
            [Iday{j}, Lam{j}, Rsamp{j}, tday{j}, Iwarn] = epiSimDieHetero(nday0,...
                ts, Rs, scenNo, distvals, k(ii));
        end
    end
